...
Cimoldal ()
{
  ...
  obj =
    fl_add_box (FL_NO_BOX, kozep, 55, 280, 12,
		"Írták: Kovács Zoltán és Bíró Csaba");
  obj =
    fl_add_box (FL_NO_BOX, kozep, 67, 280, 12,
		"Kovács Zsigmond alkotásainak illetve");
  obj =
    fl_add_box (FL_NO_BOX, kozep, 79, 280, 12,
		"a T. C. Zhao és Mark Overmars-féle");
  obj =
    fl_add_box (FL_NO_BOX, kozep, 91, 280, 12,
		"Forms Library felhasználásával.");
  gomb =
    fl_add_button (FL_NORMAL_BUTTON, kozep, 108, 280, 25,
		   "Hm, mit csinál ez a gomb?");
