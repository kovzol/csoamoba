...
Opsonsz_inic (void)
{
  ...
  gomb[1] = obj =
    fl_add_choice (FL_NORMAL_CHOICE, 100, 130, 130, 20,
		   "Kik játsszanak egymás ellen?");
  ...
  gomb[2] = obj =
    fl_add_choice (FL_NORMAL_CHOICE, 100, 180, 130, 20,
		   "Kikezdjen (Rita Johnnyval)?");
  ...
  gomb[3] = obj =
    fl_add_choice (FL_NORMAL_CHOICE, 100, 230, 130, 20,
		   "Milyen jelû legyen a számítógép, ha játszik?");
  ...
  gomb[4] = obj =
    fl_add_choice (FL_NORMAL_CHOICE, 100, 280, 130, 20,
		   "Legyen zenei aláfestés?");
  ...
  fl_set_object_lstyle (obj, FL_BOLD_STYLE);
  gomb[5] = obj =
    fl_add_choice (FL_NORMAL_CHOICE, 100, 330, 130, 20,
		   "Kire szavaznál a választásokon?");
  ...
  fl_set_object_lstyle (obj, FL_BOLD_STYLE);
  gomb[6] = obj =
    fl_add_slider (FL_HOR_NICE_SLIDER, 110, 380, 110, 30,
		   "Milyen okos legyen a gép (ha játszik)?");
  ...
  gomb[0] = obj =
    fl_add_button (FL_NORMAL_BUTTON, 100, 440, 130, 40, "Start gáme");
